...
struct VisualFrameStats {
    ...
    uint64_t color_changed_offsets = 0;
    uint64_t changed_relevant_offsets = 0;
    uint64_t color_changed_offset_candidates = 0;
    uint64_t color_offset_fanout_1 = 0;
    uint64_t color_offset_fanout_2_4 = 0;
    uint64_t color_offset_fanout_5_16 = 0;
    uint64_t color_offset_fanout_17_64 = 0;
    uint64_t color_offset_fanout_65_plus = 0;
    uint64_t color_offset_fanout_max = 0;
    uint64_t color_dirty_candidates = 0;
    uint64_t color_composed_unchanged = 0;
    uint64_t color_delta_sum_microunits = 0;
    uint64_t color_delta_max_microunits = 0;
    uint64_t color_delta_tiny = 0;
    uint64_t color_delta_small = 0;
    uint64_t color_delta_visible = 0;
