...
We as members, contributors, and maintainers pledge to make participation in the Peraviz community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
- Uploading or sharing private show files, client data, production documents, or manufacturer assets without permission.
...
Community leaders have the right and responsibility to remove, edit, or reject comments, commits, code, documentation, issues, pull requests, and other contributions that are not aligned with this Code of Conduct.

## Scope

This Code of Conduct applies within all Peraviz community spaces, including GitHub issues, pull requests, discussions, documentation, and any official communication channels related to the project.

It also applies when an individual is officially representing the Peraviz project in public spaces.
