...
static func BuildBeamParams(light: SpotLight3D, beam_angle_deg: float, beam_color: Color,
	...
	var params := {
		...
		"beam_visual_length_m": clamp(float(visual_settings.get("beam_visual_length_m", light.spot_range)), 1.0, 150.0),
		"beam_range": clamp(float(visual_settings.get("beam_visual_length_m", light.spot_range)), 1.0, 150.0),
