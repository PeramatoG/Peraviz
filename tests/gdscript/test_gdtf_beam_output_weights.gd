...
func _assert_legacy_renderer_output_weight() -> void:
	...
	assert(is_equal_approx(float(single_beam.get_instance_shader_parameter("near_alpha")), float(weighted_beam.get_instance_shader_parameter("near_alpha"))))
	assert(is_equal_approx(float(single_beam.get_instance_shader_parameter("near_emission")), float(weighted_beam.get_instance_shader_parameter("near_emission"))))
	assert(is_equal_approx(float(single_beam.get_instance_shader_parameter("photometric_output_weight")), 1.0))
	assert(is_equal_approx(float(weighted_beam.get_instance_shader_parameter("photometric_output_weight")), 0.02))
...
func _assert_volumetric_renderer_output_weight() -> void:
	...
	assert(is_equal_approx(float(single_beam.get_instance_shader_parameter("photometric_output_weight")), 1.0))
	assert(is_equal_approx(float(weighted_beam.get_instance_shader_parameter("photometric_output_weight")), 0.05))
