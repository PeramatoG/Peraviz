...
## Improvements
- Added a Beam Appearance Baseline that uses GDTF BeamType defaults for hard or soft beam edges, center-weighted beam energy, readable long-beam extinction, and separate surface-light falloff modes.
