...
- Improved DMX runtime responsiveness by moving fixture control decoding off the main thread, reducing repeated beam parameter writes, reusing fixture control buffers, and skipping unchanged non-dimmer capability work during live Art-Net updates.
