...
## Internal changes
- Reworked the DMX visual apply path to use the native cooked visual runtime as the single frame source and apply cooked fixture rows directly, reducing duplicated decode work and avoiding the previous per-fixture capability dictionary rebuild during live playback.
