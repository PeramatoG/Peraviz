...
- Restored live DMX dimmer-driven beam visibility so beam meshes and fog volumes follow native cooked beam intensity independently from the optional realtime SpotLight rendering setting.
