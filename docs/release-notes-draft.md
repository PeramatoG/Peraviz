...
- Restored live DMX gobo visibility in the native visual-frame path by preserving cached gobo metadata, preventing first-update beam initialization from overwriting live gobo texture state, and keeping texture changes separate from cheaper rotation/shake updates.
