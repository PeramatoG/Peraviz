...
- Improved DMX runtime responsiveness by moving fixture control decoding off the main thread, reducing repeated beam parameter writes, and reusing fixture control buffers during live Art-Net updates.
