...
- Corrected multi-emitter Beam photometric weighting so fixtures with many projected Beam geometries distribute their declared luminous flux across registered Beam targets instead of applying full fixture energy to every emitter.
