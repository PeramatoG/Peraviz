...
- Added the first native BeamOptics foundation: native Zoom ChannelFunction compilation, target-oriented BeamOptics rows, cached renderer-target setup for optics targets, and documentation for official Beam geometry profile priority and parametric Zoom updates.
