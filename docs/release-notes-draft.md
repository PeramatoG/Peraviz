...
- Added an exact native GDTF gobo semantic contract and generic, resolution-aware ChannelFunction mode-dependency evaluation as groundwork for later visible gobo motion.
