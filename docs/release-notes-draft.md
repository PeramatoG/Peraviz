...
## Internal changes
- Reworked the DMX visual apply path to require the native cooked visual runtime, apply real semantic change masks, update lights and beams from cooked fixture rows, and avoid the previous per-fixture capability dictionary rebuild during live playback.
