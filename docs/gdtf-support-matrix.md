...
| Gobo position/rotation/shake | Unsupported/deferred | Pos/PosRotate, WheelIndex/WheelSpin, select/position shake variants, continuous motion, and independently moving multi-wheel composition are not active. |
